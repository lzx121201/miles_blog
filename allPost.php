    ...
    <body>
        ...
        <div class="container-fluid" style="bottom: 0;">
            ...
            <div class="col-md-12 col-md-offset-1">
                <form>
                    <div class="col-md-2 form-group searchbox">
                        <input type="text" class="form-control" name="" id="exampleInputUsername" placeholder=" Search username" value="">
                    </div>
                    <div class="col-md-2 form-group searchbox">
                        <input type="text" class="form-control" name="" id="exampleInputUsername" placeholder=" Search Tags" value="">
                    </div>
                    <div class="col-md-2 form-group searchbox">
                        <input type="text" class="form-control" name="" id="exampleInputUsername" placeholder=" Search Keywords" value="">
                    </div>
                    <div class="col-md-2 form-group searchbox">
                        <input type="date" class="form-control" name="" id="exampleInputUsername" placeholder=" From" value="">
                    </div>
                    <div class="col-md-2 form-group searchbox">
                        <input type="date" class="form-control" name="" id="exampleInputUsername" placeholder=" To" value="">
                    </div>
                    <div class="col-md-2 form-group searchbox">
